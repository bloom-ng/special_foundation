            ...
            <section class="container mx-auto py-8">
                <div class="flex gap-y-4 flex-col ">
                    <div class="flex justify-between md:items-center gap-y-4 flex-col md:flex-row w-full">
                        ...
                        <div>
                            <a type="button" target="_blank" href="/admin/download/DonorInterest/csv"
                    ...
                    <tbody class="text-gray-700 text-xs">
                        ...
                        <tr>
                            ...
                            <td class="w-1/3 text-left py-3 px-4 gap-y-1">
                                <a class="text-blue-300 hover:text-blue-500" href="/admin/scholaship-donor/{{$donation->id}}">
                                ...
                                <form
                                    ...
                                    action="/admin/scholaship-donor/{{$donation->id}}"
                                    method="POST"
