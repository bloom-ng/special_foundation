<x-admin-layout title="Admin | Add Logo" page="cms-teams">
        ...
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                ...
                <div class="leading-loose">
                    <form class="" method="POST" action="/admin/cms-data/teams" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="pb-2">
                            <label class=" block  text-sm pb-1" for="name">LinkedIn URL</label>
                            <input class="px-2 block ring-1 ring-inset ring-gray-300 w-full border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " 
                                    id="linkedInUrl" name="linkedInUrl" type="text" required placeholder="linkedIn Url" aria-label="linkedIn Url">
                        </div>

                        <div class="pb-2">
                            <label class="block text-sm pb-1" for="position">Position (leave blank for Board Member)</label>
                            <input class="px-2 block ring-1 ring-inset ring-gray-300 w-full border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " 
                                    id="position" name="position" type="text" placeholder="Position" aria-label="Position">
                        </div>
                        ...
                        <div class="col-span-full mt-6" id="media-container">
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    ...
                                    src="https://via.placeholder.com/192x198"
                                    ...
                                    <div class="mt-4 flex text-sm leading-6 text-gray-600 flex-col">
                                        ...
                                        <p class="text-xs leading-5 text-red-600 ">Media up to 2MB (Dimensions - 192px x 198px)
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-span-full mt-8 " id="">
                            <label for="description"
                                class="block text-sm font-medium leading-6 text-gray-900">Profile </label>
