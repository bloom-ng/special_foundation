<x-admin-layout title="Admin | Add Logo" page="cms-partners">
        ...
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                ...
                <div class="leading-loose">
                    <form class="" method="POST" action="/admin/cms-data/partners" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="col-span-full mt-6" id="media-container">
                            <label for="partner"
                                class="block text-sm font-medium leading-6 text-gray-900">Partner
                            </label>
                            <div
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 flex text-sm leading-6 text-gray-600 flex-col">
                                        ...
                                        <p class="text-xs leading-5 text-red-600 ">Media up to 2MB (Maximum height - 90px)
                                        </p>
                                    </div>
                                </div>
                            </div>
