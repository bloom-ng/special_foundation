<x-admin-layout title="Admin | Blog List" page="blogs">
    ...
    <main class="w-full flex-grow p-6">
        ...
        <div class="w-full my-4 ">
            ...
            @php
                $viewIcon = '  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div class="flex min-w-0 gap-x-4">
                                ...
                                <div class="min-w-0 flex-auto">
                                  <a href="/admin/blogs/{{ $post->id }}" class="text-decoration-none">
                                    <p class="text-sm font-semibold leading-6 text-gray-900">{{ $post->title }} {{ $post->getPublishedAttribute() ? '' : '[Draft]' }}
