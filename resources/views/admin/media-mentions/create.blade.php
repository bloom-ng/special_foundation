<x-admin-layout title="Admin | Add Media Mention" page="media-mentions">

    <main class="w-full flex-grow p-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl text-black pb-6">Create Media Mention</h1>
        ...
        <div class="w-full mt-6">
            <form method="POST" action="/admin/media-mentions" class="bg-white rounded-lg shadow-md p-6">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('name') border-red-500 @enderror rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                            id="title" name="title" type="text" required placeholder="e.g. Kaleidoscope (Channels TV)" aria-label="Title">
                    ...
                    <div class="w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('name') border-red-500 @enderror rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                            id="url" name="url" type="url" required placeholder="https://example.com" aria-label="Link">
                    </div>
                </div>
