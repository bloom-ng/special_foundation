<x-admin-layout title="Admin | Partner Application" page="partner">
                    ...
                    <div class="flex justify-between md:items-center gap-y-4 flex-col md:flex-row w-full">
                        <div>
                            ...
                            <p
                                ...
                                See list of partner applications
                            </p>
                        </div>
                        <div>
                            <a type="button" target="_blank" href="/admin/download/PartnerApplication/csv"
                    ...
                    <tbody class="text-gray-700 text-xs">
                        ...
                        <tr>
                            ...
                            <td class="w-1/3 text-left py-3 px-4 gap-y-1">
                                <a class="text-blue-300 hover:text-blue-500" href="/admin/partners/{{$application->id}}">
    ...
    <script>
        @foreach ($applications as $application)
            ...
            const form{{$application->id}} = document.getElementById('partner-delete-{{$application->id}}');
