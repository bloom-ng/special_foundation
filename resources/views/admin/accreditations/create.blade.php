<x-admin-layout :page="'accreditations'" :title="'Create Accreditation'">
    <main class="w-full flex-grow p-6">
        ...
        <div class="flex justify-between items-center">
            <h1 class="text-3xl text-black pb-6">Create Accreditation</h1>
        ...
        <div class="w-full mt-6">
            <form method="POST" action="{{ route('admin.accreditations.store') }}" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
                @csrf
                @method('POST')
