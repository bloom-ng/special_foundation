        ...
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                ...
                <div class="leading-loose">
                    <form class="" method="POST" action="/admin/galleries/{{ $gallery->id }}"
                        ...
                        <div class="pb-2">
                            ...
                            <input
                                ...
                                id="title" name="title" value="{{ $gallery->title }}" type="text" required
                        ...
                        <div class="pb-2">
                            ...
                            <select
                                ...
                                @foreach (\App\Models\Gallery::getTypeMapping() as $key => $value)
                                    <option @if ($gallery->type == $key) selected @endif
                        ...
                        <div class="col-span-full mt-6  {{ $gallery->type === \App\Models\Gallery::TYPE_YOUTUBE ? 'hidden' : '' }}"
                            id="media-container">
                        ...
                        <div class="col-span-full mt-8 {{ $gallery->type !== \App\Models\Gallery::TYPE_YOUTUBE ? 'hidden' : '' }}"
                            id="embed-container">
                            <label for="summary" class="block text-sm font-medium leading-6 text-gray-900">Embed Code
                            </label>

                            <textarea id="value" name="value" rows="6"
                                class="block w-full font-mono border-0 bg-transparent px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $gallery->value }}</textarea>
                        </div>
