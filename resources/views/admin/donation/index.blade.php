<x-admin-layout title="Admin | Donation Leads" page="donation">
                    ...
                    <div class="flex justify-between md:items-center gap-y-4 flex-col md:flex-row w-full">
                        <div>
                            ...
                            <p
                                ...
                                See list of prospective donors
                            </p>
                        </div>
                        <div>
                            <a type="button" target="_blank" href="/admin/download/Donation/csv"
                    ...
                    <tbody class="text-gray-700 text-xs">
                        ...
                        <tr>
                            ...
                            <td class="w-1/3 text-left py-3 px-4 gap-y-1">
                                <a class="text-blue-300 hover:text-blue-500" href="/admin/donation-leads/{{$donation->id}}">
                                ...
                                <form
                                    id="donation-delete-{{$donation->id}}"
                                    action="/admin/donation-leads/{{$donation->id}}"
                                    method="POST"
                                ...
                                >
                                    ...
                                    <script>
                                        const form{{$donation->id}} = document.getElementById('donation-delete-{{$donation->id}}'); 
                                      
                                        form{{$donation->id}}.addEventListener('submit', (e) => {
                                          e.preventDefault(); // Prevent the form from submitting normally
                                          const confirmSubmit = confirm('Proceed to delete?');
                                          if (confirmSubmit) {
                                            form{{$donation->id}}.submit(); // Submit the form if the user confirms
                                          }
                                        });
                                      </script>
