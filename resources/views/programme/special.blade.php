<x-guest-layout title="Programs - Special Scholarship" page="programs">
    ...
    <div
        class="h-full flex flex-row justify-center items-center text-[10px] mt-6 lg:text-[30px] montserrat-bold font-extrabold text-[#26225F]">
        Empowering bright minds. Removing financial barriers.
    </div>
    <div class="w-full flex flex-col py-20 px-8 lg:px-20 gap-14">
        <div class="w-full sm:flex lg:flex-row sm:flex-col items-center space-y-10 lg:space-y-0 lg:space-x-10">
            <div class="w-full lg:w-1/2">
                <p class="text-lg montserrat-light font-normal mb-4">
                    The Special Scholarship supports academically exceptional students in local tertiary institutions
                    who are unable to continue their education due to financial hardship. We ensure that talent is not
                    interrupted by circumstance, and it covers tuition (including books and other materials).
                </p>
            </div>
        ...
        <div class="w-full flex flex-col lg:flex-row items-start gap-10">
            ...
            <div class="w-full lg:w-1/2 rounded-2xl">
                <img src="{{ asset("images/special_2.png") }}" alt="Special Scholarship Beneficiaries Image">
            </div>

            <div class="w-full lg:w-1/2 bg-[#25A8D6] p-6">
                <h1 class="text-[#26225F] lg:text-2xl mb-2 montserrat-bold">
                    Who Can Apply
                </h1>
                <div class="ml-6 my-2">
                    <ul class="text-base montserrat-thin font-normal list-disc lg:leading-[20px] text-white">
                        <li class="pb-1">
                            Newly admitted students into a Federal or State university.
                        </li>
                        <li class="pb-1">
                            Currently enrolled students in a Federal or State university who require financial support.
                        </li>
                    </ul>
                </div>
                ...
                <h4 class="text-[#26225F] lg:text-base montserrat-bold">
                    Academic Excellence
                </h4>
                <div class="ml-6">
                    <ul class="text-base montserrat-thin font-normal list-disc lg:leading-[20px] text-white">
                        <li class="pb-1">
                            Newly admitted: Minimum UTME score of 250 and at least 4 A’s in WAEC (or equivalent)
                        </li>
                        <li class="pb-1">
                            Current students: Minimum CGPA of 4.0 with consistent performance
                        </li>
                    </ul>
                </div>
                <h4 class="text-[#26225F] lg:text-base montserrat-bold">
                ...
                <div class="ml-6">
                    <ul class="text-base montserrat-thin font-normal list-disc lg:leading-[20px] text-white">
                        <li class="pb-1">
                            Verifiable evidence of hardship (e.g., medical report, death certificate, or guardian income
                            proof)
                        </li>
                    </ul>
                </div>
                ...
                <div class="ml-6">
                    <ul class="text-base montserrat-thin font-normal list-disc lg:leading-[20px] text-white">
                        ...
                        <li class="pb-1">
                            Reference letter from a university authority (for enrolled students)
                        </li>
                    </ul>
                </div>
                <h4 class="text-[#26225F] lg:text-base montserrat-bold">
                ...
                <div class="ml-6">
                    <p class="text-base montserrat-thin font-normal leading-[20px] text-white pb-2">
                        Support may include:
                    </p>
                    <ul class="text-base montserrat-thin font-normal list-disc lg:leading-[20px] text-white">
                        <li class="pb-1">
        ...
        <div class="w-full flex flex-col gap-8">
            ...
            <div class="flex flex-wrap gap-8">
                <div
                    ...
                    <span class="bg-white text-black rounded-[100%] py-1 px-3 montserrat-medium">1</span> Passport
                    photograph
                </div>
                <div
                    class="flex rounded-full text-white montserrat-thin font-normal py-2 pl-2 pr-6 bg-[#25A8D6] items-center w-fit gap-4">
                    <span class="bg-white text-black rounded-[100%] py-1 px-3 montserrat-medium">2</span>Admission
                    letter
                ...
                <div
                    ...
                    WAEC result or academic transcript
                </div>
                <div
                    class="flex rounded-full text-white montserrat-thin font-normal py-2 pl-2 pr-6 bg-[#25A8D6] items-center w-fit gap-4">
                    <span class="bg-white text-black rounded-[100%] py-1 px-3 montserrat-medium">4</span> Character
                    UTME result (for newly admitted students)
                </div>
                <div
                    class="flex rounded-full text-white montserrat-thin font-normal py-2 pl-2 pr-6 bg-[#25A8D6] items-center w-fit gap-4">
                    <span class="bg-white text-black rounded-[100%] py-1 px-3 montserrat-medium">5</span> University
                    reference letter
                </div>
                <div
                    class="flex rounded-full text-white montserrat-thin font-normal py-2 pl-2 pr-6 bg-[#25A8D6] items-center w-fit gap-4">
                    <span class="bg-white text-black rounded-[100%] py-1 px-3 montserrat-medium">6</span> Evidence of
                    financial hardship
                </div>
            </div>
        </div>
